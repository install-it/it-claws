...
CLAW_PRIZES: tuple[ClawPrize] = (
    ...
    },
    {
        ...
        'url': functools.partial(
                ...
                dri_name='MediaTek Wi-Fi 7 Bluetooth Driver'
        ),
        'file_type': 'zip/exe',
    ...
    },
    {
        ...
        'url': functools.partial(
                url.gigabyte,
                url='https://www.gigabyte.com/PC-Accessory/GC-WIFI7-rev-11/support',
                dri_name='MediaTek Wi-Fi 7 WIFI Driver'
        ),
        'file_type': 'zip/exe',
    ...
    },
    {
        ...
        'url': functools.partial(
                ...
                dri_name='Qualcomm Wi-Fi 7 Bluetooth Driver'
        ),
        'file_type': 'zip/exe',
    ...
    },
    {
        ...
        'url': functools.partial(
                url.gigabyte,
                url='https://www.gigabyte.com/PC-Accessory/GC-WIFI7-rev-10/support',
                dri_name='Qualcomm Wi-Fi 7 WIFI driver'
        ),
        'file_type': 'zip/exe',
    ...
    },
    {
        'group': 'tool',
        'path': 'FurMark',
        'url': functools.partial(url.furmark, variant='win64'),
        'file_type': 'zip/folder',
        'rename_as': None
    },
    {
    ...
    },
    {
        'group': 'tool',
        'path': 'y-cruncher',
        'url': functools.partial(url.y_cruncher, variant='Windows'),
        'file_type': 'zip/folder',
        'rename_as': None
    },
    {
    ...
    # },
    {
        'group': 'software',
        'path': 'VLC Player',
        'url': functools.partial(url.vlc, variant='win64-win64'),
        'file_type': 'exe',
        'rename_as': 'vlc-win64',
    },
    # {
